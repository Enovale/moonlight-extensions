...
import { SvgFromData } from "./entrypoint";
...
export default function ButtonListSettings({ value = [], setValue }: CustomComponentProps): React.ReactNode {
    ...
    return (
        <FormItem className={Margins.marginTop20} title={displayName}>
            ...
            <Flex direction={Flex.Direction.VERTICAL} className="customChatButtons-buttonList">
                {entries.map((val, i) => (
                ...
                <Flex direction={Flex.Direction.HORIZONTAL} align={Flex.Align.CENTER} className="customChatButtons-add-entry-gap">
                    <Button
                    ...
                    <Button
                        ...
                        disabled={disabled}
                        onClick={() => {
                            entries.push({ message: "meow", svg: meowData });
                            updateConfig();
                        }}
                    >
                        <SvgFromData data={meowData} />
                    </Button>
                    <Button
                        look={Button.Looks.FILLED}
                        color={Button.Colors.TRANSPARENT}
                        ...
                        disabled={disabled}
                        onClick={() => {
                            entries.push({ message: "woof", svg: woofData });
                            updateConfig();
                        }}
                    >
                        <SvgFromData data={woofData} />
                    </Button>
                </Flex>
            </Flex>
        </FormItem>
