...
import { inboxFind, bugFind } from "./finds";

const InboxComponent = spacepack.findByCode(inboxFind)?.[0]?.exports.Z;
const BugReportComponent = spacepack.findByCode(bugFind)?.[0]?.exports.Z;
